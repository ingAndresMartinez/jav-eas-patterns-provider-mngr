...
public interface INotificationService {
    ...
    void sendNotificationHandler(ProviderEntity providerEntity, RequestQuotationWrapperDto requestQuotationWrapperDto) throws IOException, MessagingException;
